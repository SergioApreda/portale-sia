...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url() ?>/assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <!-- overlayScrollbars -->
...
.loader {
  ...
  height: 100%;
  z-index: 9999;
  background: url(<?=base_url("/assets/loading.gif")?>) 
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <a class="nav-link" data-toggle="dropdown" href="#" style='font-weight: 500; font-size:14px; color:#fff'>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <?php $ruolo = str_replace("_"," ",session()->get('ruolo_dsc')); ?>
                        <span class="dropdown-item dropdown-header">Ruolo: <?php echo $ruolo; ?></span>    
